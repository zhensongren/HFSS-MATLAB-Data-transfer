...
sendA(0) = dd/1000000
    ...
    Call omatlab.GetFullMatrix("re_eps_eff","base",re_eps_eff)
    Call omatlab.GetFullMatrix("im_eps_eff","base",im_eps_eff)
    Call omatlab.GetFullMatrix("re_mu_eff","base",re_mu_eff)
    Call omatlab.GetFullMatrix("im_mu_eff","base",im_mu_eff)
    Call omatlab.GetFullMatrix("re_eps_av","base",re_eps_av)
    Call omatlab.GetFullMatrix("im_eps_av","base",im_eps_av)
    Call omatlab.GetFullMatrix("re_mu_av","base",re_mu_av)
    Call omatlab.GetFullMatrix("im_mu_av","base",im_mu_av)
    Call omatlab.GetFullMatrix("re_z_eff","base",re_z_eff)
    Call omatlab.GetFullMatrix("im_z_eff","base",im_z_eff)
    Call omatlab.GetFullMatrix("re_n_eff","base",re_n_eff)
    Call omatlab.GetFullMatrix("im_z_eff","base",im_n_eff)

Result = omatlab.Execute("plot(f,re_eps_av),plot(f,im_eps_av),plot(f,re_mu_av),plot(f,im_mu_av)")